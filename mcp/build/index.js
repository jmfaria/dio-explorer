...
import { z } from 'zod';
import { buscarTrilha, listarTecnologias, gerarCertificado, gerarDesafio, normalizarNivel, } from './logic.js';
...
server.registerTool('buscar_trilha', {
    description: 'Retorna o plano de estudos completo de uma trilha DIO com base na tecnologia. ' +
...
server.registerTool('gerar_certificado', {
    description: 'Gera um certificado fictício de conclusão de trilha DIO para um usuário. ' +
